...
public class CatBanner implements Parcelable{
	
	public CatBanner(String banner_id, String banner_image, String category, String valid_for,String valid_till) {
