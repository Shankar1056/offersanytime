 ...
 * @created on 14 Jul 2017 at 5:21 PM
 */

public class SecondTabAdapter extends RecyclerView.Adapter<SecondTabAdapter.MyViewHolder> {
	
	private List<CatDataModel> myCartModels;
	private Context context;
	private SecondFragment cart;
	...
	public SecondTabAdapter(Context context, List<CatDataModel> myCartModels, ArrayList<LocationModel> locdata, SecondFragment cart) {
