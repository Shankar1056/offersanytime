 ...
 * @created on 05 Jul 2017 at 4:10 PM
 */

public class CategoryTabAdapter extends RecyclerView.Adapter<CategoryTabAdapter.MyViewHolder> {
	...
	public CategoryTabAdapter(Context context, List<CatDataModel> myCartModels, ArrayList<LocationModel> locdata, HomeFragment cart) {
